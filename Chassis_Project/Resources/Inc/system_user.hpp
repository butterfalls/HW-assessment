...
* V1.4.3      2025-11-15      Gemini          1. [BUG修复] 修正所有 volatile 声明
*******************************************************************************
*/
...
// ------------------- 板间通信 CAN ID (CAN1) --------------------
#define CAN_ID_RX_GIMBAL_CMD_1 0x300 // [float vx][float vy]
#define CAN_ID_RX_GIMBAL_CMD_2 0x301 // [float wz][uint8_t mode]

// (PID_FOLLOW_PARAMS 需要它们)
...
// 由 CAN 中断修改，由主循环读取 -> 必须为 volatile
